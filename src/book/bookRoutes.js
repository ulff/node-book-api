...
const { BOOK, BOOK_COLLECTION, SEARCH, TOP_AUTHORS } = require('../book/response/links').resources;
...
module.exports = async function routerFactory(config) {
    ...
    const {createOrUpdate, details, getList, search, topAuthorsReport} = bookControllerFactory({bookRepository, bookService});
